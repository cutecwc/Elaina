...
{{< figure src="https://cdn.jsdelivr.net/gh/cutecwc/pucpica/blgold/Screenshot_20230303_182035.png" title="Neofetch" >}}

-肉眼可见的包数量变多了（相比于Archlinux），上面的软件包配置完成后，Manjaro（约1000）>EndeavourOS（约900）>Archlinux（约800）。但还可以接受，就懒得清理了0.0. 。

{{< figure src="https://cdn.jsdelivr.net/gh/cutecwc/pucpica/blgold/Screenshot_20230303_182303.png" title="桌面" >}}
